...
//-----CONSTRUCCION DE LA TABLA------------------------------------------------------------------------
 $table = 'productos';
 $table2 = 'inventario';
 $sql= "SELECT t2.idproductos,T2.codigo, t2.nombre, SUM(t1.cant) AS total FROM inventario 
 AS t1 RIGHT JOIN productos AS t2 ON t1.idproductos = t2.idproductos WHERE t2.status <2 GROUP BY t2.idproductos ";
