				...
				window.setTimeout(function(){window.location.href = "listoc.php";}, 2000);	
					...
					//colocar renglones
						for (var i = 0; i < noprods; i++) {
							...
							var conten = "<input type='text' id='int"+i+"'><label><input type='checkbox' id='in"+i+"'>"
							+texto+"</label><input type='hidden' name='pr"+i+"' id='pr"+i+"' value="+nart+">";
	...
	<div data-role="page" id="pagrecoc">
		...
		<div data-role = "ui-content" id="lista">
			...
			<table data-role="table">
				<thead>
					<th>OK</th><th>CANT</th><th>PRODUCTO</th>
				</thead>
				<tbody>
